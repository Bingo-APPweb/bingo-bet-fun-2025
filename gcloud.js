...
function createCloudEndpoints(emulator) {
  ...
  gcloudStorageAPI.get(
    ...
    async (req, res) => {
      ...
      if (req.query.alt === 'media') {
        return (0, shared_1.sendFileBytes)(
          getObjectResponse.metadata,
          getObjectResponse.data,
          req,
          res
        );
      }
  ...
  gcloudStorageAPI.get(['/b/:bucketId/o', '/storage/v1/b/:bucketId/o'], async (req, res) => {
    ...
    return res.status(200).json({
      ...
      items:
        (_a = listResponse.items) === null || _a === void 0
          ? void 0
          : _a.map((item) => new metadata_1.CloudStorageObjectMetadata(item)),
    });
  });
  ...
  gcloudStorageAPI.post('/b/:bucketId/o/:objectId/acl', async (req, res) => {
    emulatorLogger_1.EmulatorLogger.forEmulator(types_1.Emulators.STORAGE).log(
      'WARN_ONCE',
  ...
  gcloudStorageAPI.post('/upload/storage/v1/b/:bucketId/o', async (req, res) => {
    ...
    if (uploadType === 'multipart') {
      ...
      let dataRaw;
      try {
        ({ metadataRaw, dataRaw } = (0, multipart_1.parseObjectUploadMultipartRequest)(
          contentTypeHeader,
          await (0, request_1.reqBodyToBuffer)(req)
        ));
      } catch (err) {
...
function getIncomingFileNameFromRequest(query, metadata) {
  var _a;
  const name =
    ((_a = query === null || query === void 0 ? void 0 : query.name) === null || _a === void 0
      ? void 0
      : _a.toString()) || (metadata === null || metadata === void 0 ? void 0 : metadata.name);
