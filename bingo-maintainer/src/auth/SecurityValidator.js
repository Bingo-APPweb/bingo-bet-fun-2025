...
var SecurityValidator = /** @class */ (function () {
    function SecurityValidator() {
        this.rules = [];
    }
    SecurityValidator.prototype.validateContext = function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var events, _i, _a, rule, matches;
            return __generator(this, function (_b) {
                ...
                for (_i = 0, _a = this.rules; _i < _a.length; _i++) {
                    ...
                    if (!rule.enabled)
                        continue;
                    matches = this.evaluateConditions(rule, context);
                    if (matches) {
                        events.push({
                            ...
                            details: "Security rule \"".concat(rule.name, "\" triggered"),
                            metadata: {
                                ruleId: rule.id,
                                context: context,
                            },
    ...
    SecurityValidator.prototype.evaluateConditions = function (rule, context) {
